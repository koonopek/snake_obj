...
exports.BOARD_SIZE = Math.round(Math.floor(Math.min(window.innerHeight, window.innerWidth) * 0.90) / 10) * 10;
...
class Game {
  ...
  setMobileEvents() {
    const mc = new hammerjs_1.default.Manager(window);
    mc.add(new hammerjs_1.default.Swipe({
      event: "sw_right",
      direction: hammerjs_1.default.DIRECTION_RIGHT
    }));
    mc.on("sw_right", () => {
    ...
    mc.add(new hammerjs_1.default.Swipe({
      event: "sw_up",
      direction: hammerjs_1.default.DIRECTION_UP
    }));
    mc.on("sw_up", () => {
    ...
    mc.add(new hammerjs_1.default.Swipe({
      event: "sw_down",
      direction: hammerjs_1.default.DIRECTION_DOWN
    }));
    mc.on("sw_down", () => {
    ...
    mc.add(new hammerjs_1.default.Swipe({
      event: "sw_left",
      direction: hammerjs_1.default.DIRECTION_LEFT
    }));
    mc.on("sw_left", () => {
      this.snake.changeDirection(Snake_1.Direction.Left);
    });
    const pause = document.getElementById('pause');
    const mcPause = new hammerjs_1.default.Manager(pause);
    mcPause.add(new hammerjs_1.default.Tap());
    mcPause.on('tap', () => {
...
},{"./Board":"Board.ts","./Snake":"Snake.ts","hammerjs":"../node_modules/hammerjs/hammer.js"}],"index.ts":[function(require,module,exports) {
"use strict";
